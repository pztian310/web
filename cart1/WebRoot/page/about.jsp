...
<!--header-->
	...
	<div class="banner banner-in">
		<div class="container">
			<h6><a href="<%=path%>/page/index.jsp">关于我们</a> / <span></span></h6>
		</div>
	</div>	
		<!---->
			...
			<div class="container">
			<div class="four">
				<p>购物网站，网购好选择，全国领先的综合型网购网站。直营，正品保证，低价保障，货到付款，放心购物</p>
				<br/>
				<br/>
				<br/>
				<br/>
				<br/>
				<a href="<%=path%>/page/index.jsp" class="back">返回主页</a>
			</div>
			</div>

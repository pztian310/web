...
<!--header-->
	...
	<div class="banner banner-in">
      ...
      <table width="800" align="center" style="font-size:12px" cellpadding="0" cellspacing="0" border="1" class="pay-table">
         <tr >
            <td width="16%" height="28"><div align="center">订单ID</div></td>
            <td width="10%"><div align="center">订单号</div></td>
            <td width="22%"><div align="center">订单日期</div></td>
            <td width="22%"><div align="center">订单地址</div></td>
            <td width="17%"><div align="center">总金额</div></td>
             <td width="10%"><div align="center">查看明细</div></td>
        </tr>
       
       	<c:forEach items="${requestScope.orderList}" var="order">
         <tr>
          <td height="28"><div align="center">${order.orderID}</div></td>
            <td><div align="center">${order.orderbianhao}</div></td>
            <td><div align="center">${order.orderDate}</div></td>
            <td><div align="center">${order.orderAddress}</td>
            <td><div align="center">${order.ordermoney}yuan</div></td>
            <td><div align="center"><a href="<%=path%>/order?type=orderDetail&orderID=${order.orderID}">看明细</a></div></td>
        </tr>
       </c:forEach>

		...
		<!---->
			...
			<div class="contact-in">
				...
				<div class=" col-md-9 contact-left">
					    <form  action="<%=path %>/user?type=userLogin" method="post">
					    	<div>
						    	<span>用户名</span>
						    	<input name="loginName" type="text" class="textbox">
						    </div>
						    <div>
						    	<span>密码</span>
						    	<input name="loginPw" type="password" class="textbox">
						    </div>
						   <div>
